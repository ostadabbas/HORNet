...
def collate_fn(batch):
    ...
    return {
        "videos": videos,
        "videos_full": torch.stack([b["video_frames_b"] for b in batch]) if video_full_exists else None,
        "question": prompts,
        "answer": ground_truth,
    }


def get_combined_dataset(num_frames=16, h=288, w=288, partition="train", use_nextqa=True):
    """
